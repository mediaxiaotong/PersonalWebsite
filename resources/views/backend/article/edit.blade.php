...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('backend/article/'.$field->art_id)}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>文章标题：</th>
                        <td>
                            <input type="text" class="lg" name="art_title" value="{{$field->title}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>编辑：</th>
                        <td>
                            <input type="text" class="sm" name="art_editor" value="{{$field->editor}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>缩略图：</th>
                        <td>
                            <input type="text" size="50px" name="art_thumb" value="{{$field->thumb}}">
                            ...
                            <script type="text/javascript">
                                ...
                                $(function() {
                                    $('#file_upload').uploadify({
                                        ...
                                        'uploader' : "{{url('backend/article/upload')}}",
                    ...
                    <tr>
                        <th>关键词：</th>
                        <td>
                            <input type="text" class="lg" name="art_tag" value="{{$field->tag}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>描述：</th>
                        <td>
                            <textarea name="art_description"> {{$field->description}}</textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <script id="editor" name="art_content" type="text/plain" style="width:760px;height:300px;">{!! $field->content !!}</script>
                            <script type="text/javascript">
                                //实例化编辑器
