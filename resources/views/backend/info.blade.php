...
@section('content')
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="{{url('backend/info')}}">首页</a> &raquo; 后台基本信息
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>联系qq：</label><span>294997013</span>
                </li>
                <li>
                    <label>新浪微博：</label><span><a href="http://weibo.com/">mediaxiaotong</a></span>
                </li>
            </ul>
        </div>
    </div>
